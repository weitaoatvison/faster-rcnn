...
void DetectionForCamera()
{
	...
	string model_file   = "/mnt/data1/zdb/work/caffe_for_frcnn/zuozhen/py-faster-rcnn/models/GoogleNet_inception5/faster_rcnn_end2end/test.prototxt";
	string trained_file = "/mnt/data1/zdb/work/caffe_for_frcnn/zuozhen/py-faster-rcnn/output/GoogleNet/deepv_car_and_person/resized/frcnn_train/googlenet_faster_rcnn_iter_350000.caffemodel";
